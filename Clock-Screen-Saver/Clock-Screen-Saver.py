...
timelabel = Label(timeframe, textvariable=tkintertime,
                  fg="#808080", bg="Black", font=("NovaMono", 150))
timelabel.place(y=screen_height/2 - 60, x=screen_width/2, anchor="center")

tkinterdate = StringVar()
datelabel = Label(timeframe, textvariable=tkinterdate,
                  fg="#808080", bg="Black", font=("Bahnschrift", 30))
